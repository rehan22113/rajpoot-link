...
return (
  ...
  <div className="z-40 p-4 h-screen bg-[#090019] fixed overflow-y-auto w-full text-white">
    ...
    <div className="py-2 gap-10 overflow-y-auto flex-col flex justify-start items-center h-full">
      ...
      <nav onClick={toggleDrawer} className="space-y-6 font-bold text-xl flex flex-col justify-center items-start">
     
      <Link to="/" className="mr-5 hover:text-gray-200 hover:scale-105 transition-all">Home</Link>
      {/* <Link to="/#milestone" className="mr-5 hover:text-gray-200 hover:scale-105 transition-all">Milestone</Link> */}
      <Link to="/" className="mr-5 hover:text-gray-200 hover:scale-105 transition-all">Principal</Link>
      <Link to="/" className="mr-5 hover:text-gray-200 hover:scale-105 transition-all">Industry</Link>
      <Link to="/" className="mr-5 hover:text-gray-200 hover:scale-105 transition-all">Category</Link>
      <Link to="/" className="mr-5 hover:text-gray-200 hover:scale-105 transition-all">About us</Link>
    </nav>
