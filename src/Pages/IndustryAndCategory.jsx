...
const IndustryAndCategory = () => {
  ...
  return (
    ...
    <h1 className="text-4xl font-extrabold tracking-tight text-skin-primary"> { category?.msg=="post" && posts?.length>0?`Explore ${posts && posts[0]?.category[0]?.name} products`:category?.msg=="category"?` Explore ${cName} Products`:"No records Found"} </h1>
            </div>
