...
<section className="text-gray-600 body-font">
  <div className="container px-16 py-16 text-center mx-auto flex md:flex-row flex-col items-center">
    <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
      <img className="object-cover object-center rounded" alt="hero" src="https://dummyimage.com/720x600" />
    </div>
    <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
     
      <p className="mb-8 leading-relaxed">We have been involved in indigenous developments as well to provide the highest quality locally manufactured parts with accuracy utilizing the best suited metallurgy. Parts requiring high precision & accuracy are manufactured on the state-of-the-art CNS machines. </p>
      <p className="mb-8 leading-relaxed">Thanks to our foreign principals we also provide the consultancy, audit & surveying services in the filed geology, mining & safety.       </p>
      <p className="mb-8 leading-relaxed">We are also serving our customers outside Pakistan including central Asian & middle eastern countries. </p>
      <p className="mb-8 leading-relaxed">Our UAE based sister concern company MATIMCO Solutions LLC enables us to serve our customers with much more flexible possibilities.</p>
