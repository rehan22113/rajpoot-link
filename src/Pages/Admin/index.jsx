...
const index = () => {
  ...
  const [paths,setPath] =useState("f") 
  useEffect(()=>{
  ...
  <div className="flex flex-col justify-between flex-1 mt-6">
    <nav>
      <Link to="/myadmin-panel/" className={`flex items-center px-4 py-2 rounded-md transition-colors duration-300 transform ${paths=="/admin/"?'bg-gray-800 text-gray-200':'text-gray-400 hover:bg-gray-800 hover:text-gray-200'} `}>
      ...
      <Link to="principals" className={`flex items-center px-4 py-2 mt-5 rounded-md transition-colors duration-300 transform ${paths=="/admin/principals"?'bg-gray-800 text-gray-200':'text-gray-400 hover:bg-gray-800 hover:text-gray-200'} `}>
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15 5V7M15 11V13M15 17V19M5 5C3.89543 5 3 5.89543 3 7V10C4.10457 10 5 10.8954 5 12C5 13.1046 4.10457 14 3 14V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V14C19.8954 14 19 13.1046 19 12C19 10.8954 19.8954 10 21 10V7C21 5.89543 20.1046 5 19 5H5Z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        <span className="mx-4 font-medium">Principals</span>
      </Link>
      ...
      <Link to="industry" className={`flex items-center px-4 py-2 mt-5 rounded-md transition-colors duration-300 transform ${paths=="/admin/industry"?'bg-gray-800 text-gray-200':'text-gray-400 hover:bg-gray-800 hover:text-gray-200'} `}>
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15 5V7M15 11V13M15 17V19M5 5C3.89543 5 3 5.89543 3 7V10C4.10457 10 5 10.8954 5 12C5 13.1046 4.10457 14 3 14V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V14C19.8954 14 19 13.1046 19 12C19 10.8954 19.8954 10 21 10V7C21 5.89543 20.1046 5 19 5H5Z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
        <span className="mx-4 font-medium">Industry</span>
      </Link>
      <Link to="client" className={`flex items-center px-4 py-2 mt-5 rounded-md transition-colors duration-300 transform ${paths=="/admin/client"?'bg-gray-800 text-gray-200':'text-gray-400 hover:bg-gray-800 hover:text-gray-200'} `}>
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M15 5V7M15 11V13M15 17V19M5 5C3.89543 5 3 5.89543 3 7V10C4.10457 10 5 10.8954 5 12C5 13.1046 4.10457 14 3 14V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V14C19.8954 14 19 13.1046 19 12C19 10.8954 19.8954 10 21 10V7C21 5.89543 20.1046 5 19 5H5Z" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" />
        </svg>
