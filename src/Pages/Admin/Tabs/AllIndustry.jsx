...
<form>
  <div className="my-6">
    ...
    <input type="text" onChange={(e)=>{setAddIndustry({...addIndustry,name:e.target.value})}} id="name" value={addIndustry.name} className="border text-gray-100 text-sm rounded-lg block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500" placeholder="eg. steel industry" required />
  </div>
  <div className="my-6">
  ...
  <div className="mb-6">
    ...
    <input onChange={(e)=>{setAddIndustry({...addIndustry,image:e.target.files[0]})}} type="file" id="file" className=" border  text-gray-100 text-sm rounded-lg  block w-full p-2.5 bg-gray-700 border-gray-600 placeholder-gray-100 focus:ring-blue-500 focus:border-blue-500" required />
  </div>
